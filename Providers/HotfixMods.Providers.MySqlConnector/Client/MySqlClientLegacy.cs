...
{
    public partial class MySqlClientLegacy : IServerDbProvider, IServerDbDefinitionProvider, IClientDbProvider, IClientDbDefinitionProvider
    {
        ...
        public MySqlClientLegacy(string server, string port, string user, string password)
        {
