namespace DBCD.Providers
{
    public class GithubDBDProvider : IDBDProvider
    {
        ...
        public GithubDBDProvider()
        {
            ...
            //client.DefaultRequestHeaders.Add("Authorization", "Bearer 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"); // scope to public repo only, but try not to deploy this... EDIT: shit
        }
