...
{
    public class SpellVisualEventInfo : IInfoModel
    {
        public string StartEvent { get; set; } = "TODO";
        public string EndEvent { get; set; } = "TODO";
        public string StartMinOffsetMs { get; set; } = "TODO";
        public string StartMaxOffsetMs { get; set; } = "TODO";
