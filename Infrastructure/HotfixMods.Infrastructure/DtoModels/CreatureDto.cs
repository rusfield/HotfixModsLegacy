...
namespace HotfixMods.Infrastructure.DtoModels
{
    public class CreatureDto : DtoBase
    {
        ...
        public List<CreatureDisplayInfoOption> CreatureDisplayInfoOption { get; set; } = new();
        public List<NpcModelItemSlotDisplayInfo> NpcModelItemSlotDisplayInfo { get; set; } = new();
