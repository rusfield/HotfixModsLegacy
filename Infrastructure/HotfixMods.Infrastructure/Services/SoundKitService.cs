...
namespace HotfixMods.Infrastructure.Services
{
    public partial class SoundKitService : ServiceBase
    {
        ...
        public async Task<SoundKitDto?> GetByIdAsync(ulong id, Action<string, string, int>? callback = null)
        {
            ...
            try
            {
                ...
                var result = new SoundKitDto()
                {
                    SoundKit = soundKit,
                    EntryGroups = new(),
                    HotfixModsEntity = await GetExistingOrNewHotfixModsEntityAsync(callback, progress, (ulong)soundKit.ID),
                    IsUpdate = true
                };
