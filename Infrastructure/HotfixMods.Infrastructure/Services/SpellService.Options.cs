...
namespace HotfixMods.Infrastructure.Services
{
    public partial class SpellService
    {
        ...
        public async Task<Dictionary<ushort, string>> GetCastingTimeIndexOptions()
        {
            ...
            var spellCastTimes = await GetFromClientOnlyAsync<SpellCastTimes>();
        ...
        {
            var results = new Dictionary<ushort, string>();
            var spellDurations = await GetFromClientOnlyAsync<SpellDuration>();
        ...
        {
            var results = new Dictionary<ushort, string>();
            var spellRanges = await GetFromClientOnlyAsync<SpellRange>();
