...
namespace HotfixMods.Infrastructure.Services
{
    public partial class SpellService : ServiceBase
    {
        ...
        public async Task<SpellDto?> GetByIdAsync(ulong id, Action<string, string, int>? callback = null)
        {
            ...
            try
            {
                ...
                {
                    HotfixModsEntity = await GetExistingOrNewHotfixModsEntityAsync(callback, progress, (ulong)id),
