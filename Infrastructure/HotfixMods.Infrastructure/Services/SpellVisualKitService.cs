...
namespace HotfixMods.Infrastructure.Services
{
    public partial class SpellVisualKitService : ServiceBase
    {
        ...
        public async Task<SpellVisualKitDto?> GetByIdAsync(ulong id, Action<string, string, int>? callback = null)
        {
            ...
            try
            {
                ...
                var result = new SpellVisualKitDto()
                {
                    ...
                    HotfixModsEntity = await GetExistingOrNewHotfixModsEntityAsync((ulong)spellVisualKit.ID),
                };
