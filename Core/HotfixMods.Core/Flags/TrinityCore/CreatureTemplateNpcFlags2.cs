namespace HotfixMods.Core.Flags.TrinityCore
{
    ...
    public enum CreatureTemplateNpcFlags2 : uint
    {
        ...
        FAST_STEERING_AVOIDS_OBSTACLES = 0x00002000,   // TITLE enables avoiding obstacles when FastSteering spline flag is set
        ...
        PERSONAL_TABARD_DESIGNER = 0x00200000,   // TITLE is personal tabard designer
    }
}
